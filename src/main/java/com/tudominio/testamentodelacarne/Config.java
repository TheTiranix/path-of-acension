...
/**
 * Config comun heredada de la plantilla MDK (nunca se personalizo mas alla de los defaults).
 * Se deja como base para futuras opciones ajustables del modpack (ej. probabilidades de loot).
 */
@EventBusSubscriber(modid = TestamentoDeLaCarne.MODID, bus = Bus.MOD)
public class Config {
