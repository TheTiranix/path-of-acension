 ...
 * RaceSyncPacket): cuernos de Demonio, alas de Angel. La deformidad del Malnacido (cabeza/brazo
 * mas grande) y la altura del Ender Warrior se manejan aparte via RenderPlayerEvent.Pre/Post
 * (ver RaceRenderEvents) porque tienen que aplicarse ANTES del pase base del modelo (para que se
 * vea con la piel real del jugador, no una textura nueva superpuesta).
 */
